                ...
                <nav>
                    ...
                    <?php
                        ...
                        if(App\Session::getUser()){
                            ...
                            <a href="index.php?ctrl=topic&action=listerTopics">La liste des topics</a>
                            <a href="index.php?ctrl=categorie&action=listerCategories">La liste des catégories</a>
                        <?php
                        }
